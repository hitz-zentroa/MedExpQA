...
class CasimedicosTrainer(Seq2SeqTrainer):
    """
    The CasimedicosTrainer is an adaptation of CollieTrainer which is an adaptation of the 🤗 Transformers Trainer.
...
class ConcatDataset(Dataset[T_co]):
    ...
    """
    datasets: List[CasimedicosDataset]
    ...
    def __init__(self, datasets: Iterable[CasimedicosDataset]) -> None:
        super().__init__()
